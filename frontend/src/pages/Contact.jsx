    ...
    <div>
      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28'>
        ...
        <div className='flex flex-col justify-center items-start gap-6'>
          ...
          <p className='text-gray-500 '>Seethammadhara, Andhra Pradesh <br /> Gajuwaka, Andhra Pradesh</p>
          <p className='text-gray-500'>Tel: +91 9515219991 <br /> mattasathvik@gmail.com</p>
